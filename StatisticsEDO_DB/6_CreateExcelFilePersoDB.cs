...
{
    static class CreateExcelFilePersoDB
    {
        ...
        public static void CreateNewExcelFile(List<DataFromPersoDB> list_dataFromPersoDB)
        {
            ...
            try
            {
                ...
                workSheet.Cells[i, 15] = "Статус квитанции";
                workSheet.Cells[i, 16] = "Специалист";
                workSheet.Cells[i, 17] = "Способ представления";
                workSheet.Cells[i, 18] = "Куратор";
                workSheet.Cells[i, 19] = "УП по данным УПФР";                
                workSheet.Cells[i, 20] = "Категория";
                workSheet.Cells[i, 21] = "ИНН";
                workSheet.Cells[i, 22] = "Дата постановки в ПФР";
                workSheet.Cells[i, 23] = "Дата постановки в РО";
                workSheet.Cells[i, 24] = "Дата снятия в РО";                
                workSheet.Cells[i, 25] = "Tout_прошлый кол-во ЗЛ";
                workSheet.Cells[i, 26] = "Tout_текущий кол-во ЗЛ";                
                ...
                Excel.Range rangeZagolovok = workSheet.Range[workSheet.Cells[i, 1], workSheet.Cells[i, 26]];
                ...
                foreach (var row in list_dataFromPersoDB)
                {
                    ...
                    workSheet.Cells[j, 2] = row.codZap;
                    workSheet.Cells[j, 3] = row.raion;
                    workSheet.Cells[j, 4] = row.regNum;
                    workSheet.Cells[j, 5] = row.nameStrah;
                    workSheet.Cells[j, 6] = row.month;
                    workSheet.Cells[j, 7] = row.year;
                    workSheet.Cells[j, 8] = row.typeSved;
                    workSheet.Cells[j, 9] = row.dataPredst;
                    workSheet.Cells[j, 10] = row.resultat;
                    workSheet.Cells[j, 11] = row.dataProverki;
                    workSheet.Cells[j, 12] = row.kolZL;
                    workSheet.Cells[j, 13] = row.kolZLgood;
                    workSheet.Cells[j, 14] = row.kolZLbad;
                    workSheet.Cells[j, 15] = row.statusKvitanc;
                    workSheet.Cells[j, 16] = row.spec;
                    workSheet.Cells[j, 17] = row.specChanged;                    
                    workSheet.Cells[j, 18] = row.curator;
                    workSheet.Cells[j, 19] = row.UP;
                    workSheet.Cells[j, 20] = row.kategory;
                    workSheet.Cells[j, 21] = row.inn;
                    workSheet.Cells[j, 22] = row.dataPostPFR;
                    workSheet.Cells[j, 23] = row.dataPostRO;
                    workSheet.Cells[j, 24] = row.dataSnyatRO;                    
                    workSheet.Cells[j, 25] = row.toutOldCountZL;
                    workSheet.Cells[j, 26] = row.toutNewCountZL;                  
                ...
                //TODO: Внимание! При изменении количества ячеек с данными изменить значение диапазона
                Excel.Range rangeData = workSheet.Range[workSheet.Cells[2, 1], workSheet.Cells[list_dataFromPersoDB.Count() + 1, 26]];
                //шрифт для захваченного диапазона
                ...
                //авто ширина и авто высота
                //TODO: Внимание! При изменении количества ячеек с данными изменить значение диапазона
                Excel.Range rangeData1 = workSheet.Range[workSheet.Cells[2, 1], workSheet.Cells[list_dataFromPersoDB.Count() + 1, 4]];
                rangeData1.EntireColumn.AutoFit();
                rangeData1.EntireRow.AutoFit();
                Excel.Range rangeData2 = workSheet.Range[workSheet.Cells[2, 6], workSheet.Cells[list_dataFromPersoDB.Count() + 1, 26]];
...
End Sub
                */
                ...
                try
                {
                    ...
                    string fileNameExcel = @"C:\_Out" + @"\" + @"Perso_Реестр_общий_" + DateTime.Now.ToShortDateString() + "_.xlsx";
